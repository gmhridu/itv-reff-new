    ...
    <div className="min-h-screen">
      <div className="px-6 py-4 space-y-6 mx-auto">
        ...
        <div className="space-y-2 text-sm text-gray-600">
          <p>1. Withdrawal time is from 9:00 to 17:00 from Monday to Friday.</p>
          <p className="text-red-500">
            (After submitting the withdrawal application, it will arrive in your
            account within 0 to72 hours.)
          </p>
          <p>
            2. Withdrawals are not available on weekends and public holidays.
          </p>
        ...
        <DialogContent className="max-w-sm mx-auto">
          <DialogHeader>
            <div className="flex items-center gap-3 mb-2">
              ...
              <div>
                <DialogTitle className="text-lg">No Payment Method</DialogTitle>
              </div>
            </div>
            <DialogDescription className="text-left">
              You haven't added any bank cards yet. Please add a payment method
              to continue with withdrawal.
            </DialogDescription>
          </DialogHeader>
